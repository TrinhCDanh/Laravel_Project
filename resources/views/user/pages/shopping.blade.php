      ...
      <div class="cart-info">
        <table class="table table-striped table-bordered">
          ...
          <tr>
            ...
            <td class="quantity"><input type="text" size="1" value="{!! $item['qty'] !!}" name="quantity[40]" class="col-lg-1">
             
             </td>
             <td class="total"> <a href="#"><img class="tooltip-test" data-original-title="Update" src="{!! asset('public/user/img/update.png')!!}" alt=""></a>
              <a href="{!! url('xoa-san-pham', $item['rowId']) !!}"><img class="tooltip-test" data-original-title="Remove"  src="{!! asset('public/user/img/remove.png')!!}" alt=""></a></td>
